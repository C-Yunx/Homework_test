...
public class AdminScholarshipAddView extends JFrame{
    private void button1(ActionEvent e) {
        ...
        boolean flag = scholarshipDao.save(scholarship);
        if (flag) {
            frame.load2(null, null);
            dispose();
            JOptionPane.showMessageDialog(contentPane, "添加成功", "系统提示", JOptionPane.INFORMATION_MESSAGE);
        } else {
    ...
    public AdminScholarshipAddView(final AdminManagement frame) {
        this.frame = frame;
